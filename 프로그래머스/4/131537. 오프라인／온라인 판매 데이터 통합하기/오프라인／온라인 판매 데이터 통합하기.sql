...
-- SELECT TO_CHAR(N.SALES_DATE, 'YYYY-MM-DD') AS "SALES_DATE", N.PRODUCT_ID, NVL(N.USER_ID, NULL) AS "USER_ID", SUM(N.SALES_AMOUNT + F.SALES_AMOUNT) AS "SALES_AMOUNT"
-- FROM ONLINE_SALE N
...
-- SELECT N.SALES_DATE, N.PRODUCT_ID, N.USER_ID
-- FROM ONLINE_SALE N
-- FULL JOIN OFFLINE_SALE F
-- ON N.PRODUCT_ID = F.PRODUCT_ID
-- WHERE TO_CHAR(N.SALES_DATE, 'YYYY-MM') = '2022-03' OR TO_CHAR(F.SALES_DATE, 'YYYY-MM') = '2022-03'
...
-- SELECT TO_CHAR(N.SALES_DATE, 'YYYY-MM-DD') AS "SALES_DATE", N.PRODUCT_ID, NVL(N.USER_ID, NULL) AS "USER_ID", SUM(N.SALES_AMOUNT) AS "SALES_AMOUNT"
-- FROM ONLINE_SALE N
-- FULL JOIN OFFLINE_SALE F
-- ON N.PRODUCT_ID = F.PRODUCT_ID
-- WHERE TO_CHAR(N.SALES_DATE, 'YYYY-MM') = '2022-03' OR TO_CHAR(F.SALES_DATE, 'YYYY-MM') = '2022-03'
-- GROUP BY N.SALES_DATE, N.PRODUCT_ID, N.USER_ID, N.SALES_AMOUNT
